...
// ok above but changing clr for .. light dakr mode 
import React, { useState, useEffect } from 'react';
...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <div className={`sidebar ${isOpen ? 'open' : ''} ${isDarkMode ? 'dark-mode-sidebar' : 'light-mode-sidebar'}`}>
        <div
          className={`sidebar-close-btn ${isDarkMode ? 'dark-close-btn' : 'light-close-btn'}`}
